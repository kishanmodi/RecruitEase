...
const MultiSelect: React.FC<DropdownProps> = ({ id, label }: DropdownProps) => {
    const [options, setOptions] = useState<Option[]>([
        { value: 'ReactJs', text: '', selected: false },
        { value: 'Angular', text: '', selected: false },
        { value: 'VueJs', text: '', selected: false },
        { value: 'NodeJs', text: '', selected: false }
    ]);
