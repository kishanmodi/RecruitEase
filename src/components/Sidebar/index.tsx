                ...
                <nav className='mt-5 py-4 px-4 lg:mt-9 lg:px-6'>
                    ...
                    {!isRecruiter &&
                        <div>
                            ...
                            <ul className='mb-6 flex flex-col gap-1.5'>
                                <li>
                                    <NavLink
                                        ...
                                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/candidate-applications' ||
                            ...
                            {/* <li>
                                <NavLink
                                    to={`apply/${currentJobId}`}
                                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/apply' ||
