...
const Profile = () => {
    ...
    const [profile, setProfile] = useState({
        ...
        about: 'Meta Inc. is a social media company that specializes in connecting people all over the world. We believe in the power of community and strive to create a platform that is safe and inclusive for all.',
    });
